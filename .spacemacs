...
values."
  ...
  (setq-default
   ...
   dotspacemacs-startup-lists '(recents projects bookmarks agenda todos)
...
you should place your code here."
  ...
  (setq web-beautify-js-program 'es-beautifier)
  (setf my-head-extra
        (concat
